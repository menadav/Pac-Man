...
def parse_config(path_av: str) -> ParseConfig:
    """Parse and validate a JSON configuration file, stripping commented lines.

    Args:
        path_av: System file path to the target JSON file.

    Returns:
        A validated ParseConfig instance.

    Raises:
        ValueError: If file suffix is invalid, missing, unreadable, or corrupted.
    """
    try:
